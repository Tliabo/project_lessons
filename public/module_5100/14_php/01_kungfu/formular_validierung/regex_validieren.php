...
<ul class="explanation">
  <li>Voraussetzung für diesen Teil der Übungen ist das Verständnis von <a
            href="http://php.net/manual/de/function.preg-match.php" target="_blank"><code>preg_match()</code></a>.
  </li>
