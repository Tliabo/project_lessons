...
<ul class="explanation">
  ...
  <li>Dies ist aus Usability-Gründen sehr wichtig: Der User soll
    <strong>nicht neu mit dem Ausfüllen beginnen müssen</strong>, falls die Validierung fehlschlägt!
  </li>
  ...
  <li><strong>Hinweis:</strong> In diesem Skript wird die praktische Syntax-Kurzform
    <code>&lt;?=$vornameValue?&gt;</code> statt <code>echo</code> verwendet.<br>
                                Falls dich das irritiert, kannst du das im <a
            href="http://php.net/manual/de/function.echo.php">PHP-Handbuch</a> nachschlagen.<br>
                                Ich lege dir an's Herz, in Zukunft mit diesen Kurzformen zu arbeiten, du kannst den Code für deine Formulare so viel übersichtlicher aufbauen.
  </li>
</ul>
<div class="falle">
  <p><strong>Vorsicht Falle:</strong>
    <code>&lt;textarea&gt;</code></a> besitzt kein value-Attribut. Dies ist ein &quot;Pärli-Tag&quot; und der Startwert muss zwischen dem Anfangs- und Schlusstag notiert werden. Ausserdem empfehle ich dir, alles auf die gleiche Zeile zu schreiben (vergl. Code).
  </p>
</div>
...
<form action="usereingaben_erhalten.php" method="post">
  <div>
    ...
    <input type="text" id="vorname" name="vorname" value="<?= $vornameValue ?>">
      <?php
      echo '<input type="text" id="vorname" name="vorname" value="' . $vornameValue . '">';
      ?>
  </div>
  <div>
