...
if (isset($_POST['go'])) {
	// ja, wir sind im zweiten oder xten Affenschwanz-Durchgang
	...
	// Das heisst, das Formular wurde frisch geladen und somit wurden noch keine User-Eingaben oder Klicks getätigt.
